...
const VentureBuilder = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    formDataToSend.append('position', 'Venture Builder');
    formDataToSend.append('sourcePage', 'Venture-Builder Page');
    
    if (formData.resume) {
      formDataToSend.append('resume', formData.resume);
    }

    console.log('Submitting Venture Builder application with file upload');

    try {
      const web3FormData = new FormData();
      web3FormData.append("access_key", "ffe2efec-35be-401c-bf12-6aa56b81ba46");
      web3FormData.append("subject", `Venture Builder Application: ${formData.name}`);
      ...
      web3FormData.append("position", "Venture Builder");
      web3FormData.append("formType", "Venture Builder Application");
      ...
      if (data.success) {
        console.log('Venture Builder application submitted successfully via Web3Forms');
