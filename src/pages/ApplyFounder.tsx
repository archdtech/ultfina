...
const ApplyFounder = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      formDataToSend.append('subject', `Founder Application: ${formData.name}`);
...
${formData.message}
      `.trim());
      formDataToSend.append('from_name', 'Ultiro Founders');
      formDataToSend.append('reply_to', formData.email);

      console.log('Submitting founder application via Web3Forms');
