...
${formData.message}
      `.trim());
      formDataToSend.append('from_name', 'Ultiro Contact');
      formDataToSend.append('reply_to', formData.email);

      console.log('Submitting contact form via Web3Forms');
      ...
      if (response.ok) {
        ...
        throw new Error(errorResult.message || 'Failed to submit contact form');
      }
    } catch (error: any) {
